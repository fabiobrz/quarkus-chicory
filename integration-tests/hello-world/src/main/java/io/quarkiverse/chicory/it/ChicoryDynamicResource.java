...
public class ChicoryDynamicResource {
    ...
    @ChicoryInstance("operation-dynamic")
    Instance dynamicOperationInstance;
    ...
    public Response hello() {
         ...
         * We set the dynamicModuleInstance value in the "upload" method already, so this is all commented out and
         ...
         * .build();
         * }
         * dynamicModuleInstance = Instance.builder(wasms.get("operation-dynnamic")).build();
         *
         */
        var result = dynamicOperationInstance.export("operation").apply(41, 1);
    ...
    public Response upload(@RestForm("module") FileUpload wasmModule,
        ...
        try (final InputStream wasmModuleInputStream = Files.newInputStream(wasmModule.uploadedFile())) {
            ...
            dynamicOperationInstance = Instance.builder(parsedModule).build();

...
public class ChicoryStaticResource {
    ...
    @Inject
    @MachineFactoryBinding("operation-static")
    ...
    @PostConstruct
    public void init() {
        wasm = wasms.get("operation-static");
        ...
        Instance.Builder builder = Instance.builder(wasm.getModule()).withMachineFactory(machineFactory);
        if (ExecutionMode.RuntimeCompiler.equals(wasm.getExecutionMode())) {

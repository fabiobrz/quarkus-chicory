...
##quarkus.chicory.modules.operation.wasm-file=${project.basedir}/src/main/resources/wasm/operation.wasm
...
public class ChicoryResource {
    ...
    public void init() {
        ...
        staticModuleInstance = wasmQuarkusContext.chicoryInstance();
    }
...
As you can see, the injected `WasmQuarkusContext` bean can be used to retrieve a `com.dylibso.chicory.runtime.Instance` object,
